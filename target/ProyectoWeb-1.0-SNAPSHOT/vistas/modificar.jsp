...
<html>
    ...
    <body style="background-color: rgb(74, 5, 74)">        
        <div class="container" >
            <h1 class="d-flex justify-content-center" style="margin-top: 3%; color: white">Modificar Socio</h1>
                <div class="row" >
                    <%
		    ...
		    %>
                    <form class="p-5" method="POST" action="SociosController?accion=actualizar">
                        ...
                        <button type="submit" class="btn btn-light" style="margin-bottom: 3%">Modificar </button>
